...
#include <epigraph/Models/SixrdOde.hpp>
...
public:
    ...
    using coupling_type = Eigen::Matrix<coupling_scalar_type, Eigen::Dynamic, Eigen::Dynamic>;
    ...
    NetEpiComp(Eigen::Index dim, Eigen::Index compartments) {
        ...
        m_coupling = coupling_type::Zero(dim, dim);
    }
