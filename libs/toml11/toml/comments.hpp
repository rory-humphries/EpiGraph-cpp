...
#  endif
    ...
    inline bool operator==(const preserve_comments &lhs, const preserve_comments &rhs) {
...
// your program.
        ...
        template<typename T, bool C>
        empty_iterator<T, C>
        operator+(typename empty_iterator<T, C>::difference_type,
                  const empty_iterator<T, C> &rhs) noexcept { return rhs; }

        template<typename T, bool C>
        empty_iterator<T, C>
        operator+(const empty_iterator<T, C> &lhs,
                  typename empty_iterator<T, C>::difference_type) noexcept { return lhs; }
