...
BOOST_AUTO_TEST_CASE(test_value_as_literal) {
    ...
    }
    {
        ...
        }
        {
            ...
            const bool result = (toml::get<std::vector<int>>(toml::get<toml::array>(v3).front()) ==
                                 std::vector<int>{1});
            BOOST_TEST(result);
        }
        {
            ...
            const bool result = (toml::get<std::vector<int>>(toml::get<toml::array>(v4).front()) ==
                                 std::vector<int>{1});
            BOOST_TEST(result);
        }
    }
