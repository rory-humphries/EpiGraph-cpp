...
BOOST_AUTO_TEST_CASE(test_time_value) {
    ...
    TOML11_TEST_PARSE_EQUAL_VALUE(parse_value < toml::value >, "07:32:00.99",
                                  toml::value(toml::local_time(7, 32, 0, 990, 0)));
    TOML11_TEST_PARSE_EQUAL_VALUE(parse_value < toml::value >, "07:32:00.999",
                                  toml::value(toml::local_time(7, 32, 0, 999, 0)));
    TOML11_TEST_PARSE_EQUAL_VALUE(parse_value < toml::value >, "07:32:00.999999",
                                  toml::value(toml::local_time(7, 32, 0, 999, 999)));
}
...
BOOST_AUTO_TEST_CASE(test_datetime_value) {
    TOML11_TEST_PARSE_EQUAL_VALUE(parse_value < toml::value >, "1979-05-27T07:32:00",
                                  toml::value(toml::local_datetime(toml::local_date(1979, toml::month_t::May, 27),
                                                                   toml::local_time(7, 32, 0))));
