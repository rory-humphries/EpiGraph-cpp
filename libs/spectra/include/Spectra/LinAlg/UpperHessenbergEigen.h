            ...
            for (Index n = size - 1; n >= 0; n--) {
                ...
                if (q == Scalar(0)) {
                    ...
                    if (abs(m_matT.coeff(n, n - 1)) > abs(m_matT.coeff(n - 1, n))) {
                        ...
                        Complex cc = Complex(Scalar(0), -m_matT.coeff(n - 1, n)) /
                                     Complex(m_matT.coeff(n - 1, n - 1) - p, q);
                        ...
                        if (m_eivalues.coeff(i).imag() < Scalar(0)) {
                            ...
                            if (m_eivalues.coeff(i).imag() == Scalar(0)) {
                                ...
                                if (abs(x) > (abs(lastw) + abs(q))) {
                                    ...
                                    cc = Complex(-lastra - y * m_matT.coeff(i, n - 1),
                                                 -lastsa - y * m_matT.coeff(i, n)) / Complex(lastw, q);
