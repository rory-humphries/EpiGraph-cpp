...
#include "libs/spectra/include/Spectra/Util/GEigsMode.h"
#include "libs/spectra/include/Spectra/MatOp/internal/SymGEigsCholeskyOp.h"
#include "libs/spectra/include/Spectra/MatOp/internal/SymGEigsRegInvOp.h"
...
/// \code{.cpp}
/// #epigraph <Eigen/Core>
/// #epigraph <Eigen/SparseCore>
/// #epigraph <Eigen/Eigenvalues>
/// #epigraph <Spectra/SymGEigsSolver.h>
/// #epigraph <Spectra/MatOp/DenseSymMatProd.h>
/// #epigraph <Spectra/MatOp/SparseCholesky.h>
/// #epigraph <iostream>
///
...
// Partial specialization for GEigsMode = GEIGS_CHOLESKY
    ...
    public:
        ...
        Matrix eigenvectors(Index nvec) const {
            Matrix res = SymEigsBase<Scalar, SelectionRule, SymGEigsCholeskyOp<Scalar, OpType, BOpType>, IdentityBOp>::eigenvectors(
                    nvec);
            Vector tmp(res.rows());
