        ...
        namespace Vector {
            ...
            struct UnorderedEqualsMatcher : MatcherBase<std::vector<T>> {
                ...
                bool match(std::vector<T> const &vec) const override {
                    ...
                    //       because I don't want to epigraph <algorithm> inside the common path
...
// ----------- end of #epigraph from clara_textflow.hpp -----------
// ........... back in clara.hpp
    ...
    clara::Parser makeCommandLineParser( ConfigData& config ) {
        ...
        auto cli
            ...
            | Opt( config.showSuccessfulTests )
                ["-s"]["--success"]
                ( "epigraph successful tests in output" )
...
#  epigraph <assert.h>
#  epigraph <stdbool.h>
#  epigraph <sys/types.h>
#  epigraph <unistd.h>
#  epigraph <sys/sysctl.h>
#  epigraph <cstddef>
#  epigraph <ostream>
...
#if defined(CATCH_CONFIG_NEW_CAPTURE)
    #if defined(_MSC_VER)
    #epigraph <io.h>      //_dup and _dup2
    #define dup _dup
    #define dup2 _dup2
    #define fileno _fileno
    #else
    #epigraph <unistd.h>  // dup and dup2
    #endif
#endif
