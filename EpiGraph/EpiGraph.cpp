...
auto print_banner2() -> void {
  std::cout << "                                                               "
               ...
               "  MM    `7                .dP'     `M                          "
               "  MM            \n"
               "  MM   d   `7MMpdMAo.`7MM dM'       ` `7Mb,od8 ,6\"Yb. "
               "`7MMpdMAo. MMpMMMb.      \n"
               "  MMmmMM     MM   `Wb  MM MM            MM' \"'8)   MM   MM   "
               "`Wb MM    MM      \n"
               "  MM   Y  ,  MM    M8  MM MM.    `7MMF' MM     ,pm9MM   MM    "
               "M8 MM    MM      \n"
               "  MM     ,M  MM   ,AP  MM `Mb.     MM   MM    8M   MM   MM   "
               ",AP MM    MM      \n"
               ".JMMmmmmMMM  MMbmmd' .JMML. `\"bmmmdPY .JMML.  `Moo9^Yo. "
               "MMbmmd'.JMML  JMML.    \n"
               "             MM                                         MM     "
               "                \n"
               "           .JMML.                                     .JMML.   "
